<template>
  <div class="rank-info-content plist-info">
    ...
    <div class="plist-desp container">
      ...
      <img src="../../assets/img/close_icon.png" @click="toggleDesp" class="plist-desp-icon" v-if="hideDesp">
      <img src="../../assets/img/open_icon.png" @click="toggleDesp" class="plist-desp-icon" v-else>
    </div>
