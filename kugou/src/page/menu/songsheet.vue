<template>
  <div class="rank-info-content plist-info">
    ...
    <div class="plist-desp container">
      ...
      <img src="../../assets/img/close_icon.png" alt="" @click="toggleDesp" class="plist-desp-icon" v-if="hideDesp">
      <img src="../../assets/img/open_icon.png" alt="" @click="toggleDesp" class="plist-desp-icon" v-else>
    </div>
    ...
    <div class="rank-info-list">
      <mt-cell v-for="(item,index) in songList" :title="item.title" @click.native="playAudio(index)">
        <img src="../../assets/img/download_icon.png" width="20" height="20">
      </mt-cell>
    </div>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      getList(){
        ...
        var infoID = this.$route.params.id; //http://router.vuejs.org/zh-cn/advanced/data-fetching.html
